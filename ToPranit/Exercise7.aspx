<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exercise7.aspx.cs" Inherits="Day_5_6.Exercise7" %>
...
<body>
    ...
    <td></td>
        <td>
            <asp:DropDownList ID="DDL" runat="server" Height="25px" Width="100px" 
